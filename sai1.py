...
cl = LINETCR.LINE()
cl.login(token="EmvyOzAoPguxVhPVH532.PmVJKbFqEeHYheH/INXEGG.cajGpUP+OCh99tXRXEkgFuOhayHnrVQp2S6h9fkhRcA=")
cl.loginResult()
...
helpMessage ="""  BOT ทราย BOTป้องกัน+BOTแท็คชื่อ
รายชื่อคำสั่งแต่ละคำ+รายละเอียด

1. sai help     คำสั่งเพื่อเรียกดูรายการคำสั่งทั้งหมด
